...
def generate_wake_up_hour(persona):
  ...
  for retry in range(3):
    try:
      temp_return=int(run_gpt_prompt_wake_up_hour(persona)[0])
      break
...
def generate_hourly_schedule(persona, wake_up_hour): 
  ...
  for i in range(diversity_repeat_count): 
    ...
    print("n_m1_activity_set", n_m1_activity_set)
    print("len of n_m1_activity_set", len(n_m1_activity_set))
  ...
  print("~~~~compressing the hourly schedule~~~~")
  ...
  for i in n_m1_activity: 
    ...
    print("_n_m1_hourly_compressed: ", _n_m1_hourly_compressed)
...
@trace
def _long_term_planning(persona, new_day, sim_folder): 
  """
  ...
  with open(f'{sim_folder}/personas/{persona.scratch.name}/data.pickle', 'wb') as f:
  ...
  if new_day == "First day": 
    ...
    print("daily req: ", persona.scratch.daily_req)
  ...
  persona.scratch.f_daily_schedule = generate_hourly_schedule(persona, 
                                                              wake_up_hour)
  print("daily schedule: ", persona.scratch.f_daily_schedule)
...
@trace
def plan(persona, maze, personas, new_day, retrieved, sim_folder): 
  """
  ...
  with open(f'{sim_folder}/personas/{persona.scratch.name}/data_after.pickle', 'wb') as f:
      pickle.dump(persona, f)
  print("saved after decomp")
