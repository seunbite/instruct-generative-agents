...
class Persona: 
  ...
  @trace
  def plan(self, maze, personas, new_day, retrieved, sim_folder):
    """
  ...
  def move(self, maze, persona_name, personas, curr_tile, curr_time, sim_folder):
    """
    ...
    print(persona_name, "movement start")
