...
class ReverieServer: 
  ...
  def start_server(self, int_counter): 
    ...
    while (True): 
      print("CURRENT TIME IS:", int_counter)
      ...
      print("CURRENT ENV FILE IS:", curr_env_file)
      ...
      if env_retrieved: 
          ...
          for persona_name, persona in self.personas.items(): 
            ...
            next_tile, pronunciatio, description = persona.move(
              self.maze, persona_name, self.personas, self.personas_tile[persona_name], 
              self.curr_time, sim_folder)
          ...
          if not os.path.isdir(f"{sim_folder}/movement"):
